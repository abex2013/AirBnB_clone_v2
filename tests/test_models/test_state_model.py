#!/usr/bin/python3
""" Defines unittests for state model """
...
class TestState(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test instantiating State class with no arguments"""
    ...
    def test_created_at_is_public_datetime(self):
        """Test created_at is public datetime"""
        self.assertEqual(datetime, type(State().created_at))

    def test_updated_at_is_public_datetime(self):
        """Test updated_at is public datetime"""
    ...
    def test_two_states_unique_ids(self):
        """Test two states with same id are not the same"""
        st1 = State()
        st2 = State()
        self.assertNotEqual(st1.id, st2.id)

    def test_two_states_different_created_at(self):
        """Test two states with different created_at are not the same"""
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_two_states_different_updated_at(self):
        """Test two states with different updated_at are not the same"""
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_args_unused(self):
        """Test unused args raise TypeError"""
        st = State(None)
...
class TestSave(unittest.TestCase):
    ...
    @classmethod
    def setUp(self):
        """Set up State class for testing"""
        try:
    ...
    def tearDown(self):
        """Tear down State class for testing"""
        try:
            os.remove("file.json")
        except IOError:
            pass
    ...
    def test_two_saves(self):
        """Test saving a single State object twice"""
        st = State()
        sleep(0.05)
        first_updated_at = st.updated_at
        st.save()
    ...
    def test_save_with_arg(self):
        """Test saving a single State object with a custom id"""
        st = State()
        with self.assertRaises(TypeError):
            st.save(None)

    def test_save_updates_file(self):
        """Test saving a single State object and updating the file"""
        st = State()
        st.save()
        stid = "State." + st.id
...
class TestTodict(unittest.TestCase):
    ...
    def test_to_dict_contains_correct_keys(self):
        """Test to_dict method returns a dictionary with correct keys"""
        st = State()
    ...
    def test_to_dict_contains_added_attributes(self):
        """Test to_dict method returns a dictionary with added attributes"""
        st = State()
    ...
    def test_to_dict_output(self):
        """Test to_dict method returns a dictionary with correct values"""
        dt = datetime.today()
        st = State()
        st.id = "123456"
        st.created_at = st.updated_at = dt
